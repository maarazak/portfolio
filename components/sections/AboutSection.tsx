                ...
                <div className="flex flex-col items-start gap-4">
                    <div className="overflow-hidden">
                        <div className="dark:text-white text-animation">
                            Je suis MAHAMADOU ALI Abdoul razak, fondateur de GotheyeSoft et développeur web et mobile
                            avec 3+ ans d'expérience en ingénierie logicielle, spécialisé en
                    ...
                    <div className="flex gap-1 flex-col items-start">
                        ...
                        <div className="overflow-hidden">
                            <div className="dark:text-white text-animation">
                                Master en génie logiciel à l'IFOAD, avec un accent
                                sur l'architecture logicielle, la sécurité et les tests.
                            </div>
                        </div>
                    </div>
                </div>
