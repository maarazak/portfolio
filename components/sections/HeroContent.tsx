...
<div ref={sectionRef}
    ...
    <div className="overflow-hidden mt-5">
        <div className="relative flex flex-col items-center">
            ...
            <div
                className="text-animation mt-4 text-center text-xl md:text-2xl font-semibold text-black dark:text-white">
                Abdoul Razak
            </div>
        </div>
    </div>
    ...
    <div className="overflow-hidden">
        <div className="text-animation text-2xl md:text-4xl font-semibold">
            ...
            <span className="text-accentColor"> Full-Stack Web et Mobile</span>{" "}

        </div>
    </div>

    <div
        className="w-[300px] md:w-[370px] relative z-30 text-center text-sm dark:bg-[linear-gradient(#fff,rgba(255,255,255,.6))] inline-block text-black dark:text-transparent bg-clip-text">
        Spécialisé en{" "}
        <span className="font-semibold text-blue-600">PHP - Laravel</span> et{" "}
        <span className="font-semibold  text-blue-600">Dart - Flutter</span>, passionné par la conception de backends
        solides, scalables et d'interfaces optimisées pour offrir une expérience utilisateur fluide.
    </div>

    <div
        className="bio-animation dark:bg-[linear-gradient(#fff,rgba(255,255,255,.6))] inline-block text-black dark:text-transparent bg-clip-text text-md md:text-lg">
