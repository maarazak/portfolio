...
<div ref={sectionRef}
    ...
    <div className="overflow-hidden text-center">
        ...
        <span className="font-semibold text-accentColor">Dart - Flutter - Wordpress</span>
    </div>
    <div
        ...
        <span className="block mt-2">
            De l'analyse à la mise en production, je vous accompagne dans le développement ou pour booster votre
            activité.
        </span>
    </div>
