...
export default function ContactSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="contact"
      className="max-h-max bg-gray-100 dark:bg-[#161D1F] py-[80px] px-10 lg:px-[5%]"
    >
      <div className="w-full max-w-[1100px] h-full m-auto flex flex-col gap-20 items-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex gap-4">
            ...
            <Link
              href="https://www.linkedin.com/in/mahamadoualiabdoulrazak/"
              aria-label="Contact me on Linkedin"
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full group flex items-center gap-2 hover:border-accentColor border py-[5px] px-4"
        ...
        <div className="end-title dark:text-white text-md mt-6">
          Créé avec ❤️ par{" "}
          <a href="tel:+22670147315" className="text-green-500">
